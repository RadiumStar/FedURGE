...
:src: [SalUn: Empowering Machine Unlearning via Gradient-based Weight Saliency in Both Image Classification and Generation](https://arxiv.org/pdf/2310.12508), [Github Repo](https://github.com/optml-group/unlearn-saliency); [FedUNRAN: On-device Federated Unlearning via Random Labels](https://ieeexplore.ieee.org/document/10825563), [Github Repo](https://github.com/alessiomora/FedUNRAN)
"""
...
class ClientFedRL(Client):
    ...
    def local_refinement(self, loader: Optional[DataLoader] = None) -> None:
        """Local refinement method for FedRL algorithm
...
class ServerFedRL(Server): 
    def __init__(self, global_model: nn.Module, args=None):
        """Federated Learning Server for FedRL Algorithm
